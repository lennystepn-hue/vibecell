...
from app.models import Project, ProjectStack, StackItem
...
async def bulk_import(
    ...
    for item in body.repos:
        ...
        try:
            ...
            # Shared writer used by both GitHub import AND MCP vibecell_sync_repo.
            try:
                ...
                await apply_enrichment_to_project(
                    db,
                    project=project,
                    workspace_id=auth.active_workspace_id,
                    enriched=enriched,
